...
export const KlineEx_White = {
  ...
  riseColor: "#0D7680",
  fallColor: "#8F223A",
  styles: "custom_exchange_white"
};

export const KlineSimple_White = {
  riseColor: "#0D7680",
  fallColor: "#8F223A",
  lineColor: "#DBE0E6",
  ...
  crossover: "#A0A2B2",
  gridColor: "#efefef",
  styles: "custom_simple_white"
};

export const KlineSimple_Black = {
  riseColor: "#38AF75",
  fallColor: "#E75A5B",
  lineColor: "#292D30",
  textColor: "#545D69",
  ...
  crossover: "#4F5E72",
  gridColor: "#243142",
  styles: "custom_simple_black"
};

export const handleToggleTheme = (options) => ({
...
export const handleToggleThemeStudies = ({fallColor, riseColor}) => ({
